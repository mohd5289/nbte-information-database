...
use App\Models\VEI;
use App\Models\VEIProgramme;
use Illuminate\Http\Request;

class VEIsController extends Controller
{
    //
    public function getAllInstitutionsAndProgrammes(Request $request)
    {
        $institutionsWithPrograms = VEI::with('programmes')->get();
        $query = VEI::query();
    ...
    public function createInstitutionWithProgrammes(Request $request){
        ...
        $existingInstitution = VEI::where('name', $validatedData['institution_name'])->first();
